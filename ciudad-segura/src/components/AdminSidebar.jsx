...
export default function AdminSidebar({ activeTab, setActiveTab, onLogout, resetSelection }) {
  ...
  const handleNavClick = (tabName) => {
    ...
    if (resetSelection) resetSelection(); // Resetea la organización seleccionada si existe
  };
    ...
    <aside style={{ 
      ...
      <div style={{ padding: '32px 24px', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
          <div style={{ width: '32px', height: '32px', backgroundColor: 'white', borderRadius: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--deep-blue)' }}>
        ...
        <span style={{ fontSize: '0.8rem', opacity: 0.6, letterSpacing: '0.05em', textTransform: 'uppercase' }}>Gestión Ciudadana v1.0</span>
      </div>

      {/* Navegación */}
      <nav style={{ flex: 1, padding: '24px 16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
        <div style={{ fontSize: '0.75rem', textTransform: 'uppercase', color: 'rgba(255,255,255,0.4)', padding: '0 12px', marginBottom: '8px', fontWeight: 700 }}>Principal</div>
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"></rect><line x1="7" y1="2" x2="7" y2="22"></line><line x1="17" y1="2" x2="17" y2="22"></line><line x1="2" y1="12" x2="22" y2="12"></line></svg> 
          Organizaciones
        </button>
      </nav>
      ...
      <div style={{ padding: '24px', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
          <div style={{ width: '36px', height: '36px', borderRadius: '50%', backgroundColor: 'var(--vibrant-blue)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold' }}>A</div>
          <div>
